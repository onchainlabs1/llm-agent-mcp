...
class Employee(BaseModel):
    ...
    id: str = Field(default_factory=lambda: str(uuid4()), description="Unique employee identifier")
    ...
    status: str = Field(default="active", description="Employee status (active, inactive, terminated)")
...
class Department(BaseModel):
    ...
    id: str = Field(default_factory=lambda: str(uuid4()), description="Unique department identifier")
...
class PerformanceReview(BaseModel):
    ...
    id: str = Field(default_factory=lambda: str(uuid4()), description="Unique review identifier")
...
class HRService:
    ...
    def _ensure_data_files(self) -> None:
        ...
        try:
            ...
            with open(self.departments_file, 'w') as f:
                json.dump(data, f, indent=2, default=str)
            self.logger.info(f"Created new departments data file: {self.departments_file}")
    ...
    def create_employee(self, employee_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"Created employee: {employee.first_name} {employee.last_name} (ID: {employee.employee_id})")
    ...
    def get_employee(self, employee_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            for employee in data["employees"]:
                if employee["id"] == employee_id or employee["employee_id"] == employee_id:
                    return employee
    ...
    def update_employee(self, employee_id: str, update_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
    ...
    def search_employees(self, query: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for employee in data["employees"]:
                if (query_lower in f"{employee.get('first_name', '')} {employee.get('last_name', '')}".lower() or
                    query_lower in employee.get("email", "").lower() or
                    query_lower in employee.get("position", "").lower()):
    ...
    def create_department(self, department_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"Created department: {department.name} (Code: {department.code})")
    ...
    def get_department(self, department_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            for department in data["departments"]:
                if department["id"] == department_id or department["code"] == department_id:
                    return department
    ...
    def create_performance_review(self, review_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"Created performance review for employee: {review.employee_id}")
            return review.dict()
    ...
    def get_employee_reviews(self, employee_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.error(f"Error getting reviews for employee {employee_id}: {str(e)}")
            raise
