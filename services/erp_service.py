...
class Product(BaseModel):
    ...
    min_stock_level: int = Field(default=10, description="Minimum stock level for reorder")
...
class Order(BaseModel):
    ...
    id: str = Field(default_factory=lambda: str(uuid4()), description="Unique order identifier")
    ...
    items: List[Dict[str, Any]] = Field(description="Order items with product SKU and quantity")
